...
wire c1_w1;
  ...
  and #(2) (c2_w1, p1, g0);
  and #(2) (c2_w2, p1, p0, cin);
  or  #(2) (c2, g1, c2_w1, c2_w2);

  and #(2) (c3_w1, p2, g1);
  and #(2) (c3_w2, p2, p1, g0);
  and #(2) (c3_w3, p2, p1, p0, cin);
  or  #(2) (c3, g2, c3_w1, c3_w2, c3_w3);

  and #(2) (c4_w1, p3, g2);
  and #(2) (c4_w2, p3, p2, g1);
  and #(2) (c4_w3, p3, p2, p1, g0);
  and #(2) (c4_w4, p3, p2, p1, p0, cin);
  or  #(2) (cout, g3, c4_w1, c4_w2, c4_w3, c4_w4);
